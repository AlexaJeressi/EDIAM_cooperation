...
root <- file.path(getwd(), "")
dir.inputs <- file.path(root, "Inputs/")
dir.harness <- file.path(root, "Harness/")
dir.output <- file.path(root, "Outputs/")
...
write.csv(prim.data, file.path(dir.output, "prim.data.csv"), row.names = FALSE)
...
write.csv(modelruns, file.path(dir.output, "runs.models.csv"), row.names = FALSE)
